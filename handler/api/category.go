...
func (c *categoryAPI) CreateNewCategory(w http.ResponseWriter, r *http.Request) {
	...
	var categoryStore = entity.Category{Type: category.Type, UserID: idInt}
	categoryStore, err = c.categoryService.StoreCategory(r.Context(), &categoryStore)
